package com.tangv.oms.core.aspect;
...
public class InsertUpdateAspect {
    ...
    @Pointcut("execution(* com.tangv.core.dao.*Mapper.update*(..))")
    public void aroundUpdate() {}

    @Pointcut("execution(* com.tangv.core.dao.*Mapper.insert*(..))")
    public void aroundInsert() {}

    @Pointcut("execution(* com.tangv.core.dao.*Mapper.insertList(..))")
